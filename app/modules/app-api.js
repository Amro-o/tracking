...
async function loadAndDisplayLogos() {
  try {
    ...
    state.settings.calendarType    = settings.calendarType    || localStorage.getItem('calendarType') || 'hijri';
    localStorage.setItem('calendarType', state.settings.calendarType);
    updateTodayBadge(state.settings.dateFormat);
    // Refresh live date in clock when calendar type changes
...
async function navigate(page) {
  ...
  switch(page) {
    ...
    case 'admissions': initAdmissionsPage(); _updateAdmissionLinkBanner(); break;
